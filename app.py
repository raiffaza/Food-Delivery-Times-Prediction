...
with col2:
    st.image("/mnt/data/uber eats.png", width=250)
...
""")
st.image("/mnt/data/uber eats business problem.jpeg", width=450)
...
st.image("/mnt/data/uber eats company profile.jpeg", width=450)
